...
function Home() {
  return (
    ...
    <div className="Home1 w-full h-screen bg-[#090c31] text-white" id="home">
      <main className="relative w-full h-full flex justify-center flex-col uppercase items-end p-8 before:content-[''] before:absolute before:inset-0 before:bg-cover before:bg-no-repeat before:bg-[url('./assets/1.png')] before:opacity-50 before:blur-sm">
        <h1 className="relative z-10 text-5xl sm:text-6xl md:text-8xl">Vishal Tomar</h1>
        <p className="relative z-10 text-xs sm:text-sm md:text-base font-semibold">
          Nemo numquam omnis sint maiores enim sunt mollitia cum ipsa sit aperiam!
        </p>
      </main>
    </div>
  
    <div className="Home2 w-full h-auto bg-[#090c31] text-white flex flex-col sm:flex-row items-center justify-center p-5">
      <img
      ...
      <div className="w-[90%] sm:w-[50%] flex flex-col justify-center items-center mt-5 sm:mt-0 p-5 md:p-10">
        <p className="text-sm md:text-base text-center">
          ...
          perspiciatis quas possimus quibusdam animi dolorem praesentium quidem
          assumenda blanditiis dicta.
        </p>
      </div>
    </div>
    ...
    >
      <div className="w-[90%] md:w-[70%] bg-white text-black rounded-tl-none rounded-tr-[150px] md:rounded-tr-[200px] rounded-br-[150px] md:rounded-br-[200px] rounded-bl-none flex flex-col justify-center items-center p-8 md:p-10">
        ...
        <p className="text-sm sm:text-base md:text-lg text-justify">
          ...
          Officiis sed cupiditate veritatis, aliquam laborum sint dolores
          consectetur error tenetur dolorum.
        </p>
      </div>
    </div>
